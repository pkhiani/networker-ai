document.addEventListener("DOMContentLoaded", () => {
    ...
    const DashboardBtn = document.getElementById("dashboardIcon");
            ...
            chrome.scripting.executeScript({
                ...
                chrome.tabs.sendMessage(tabs[0].id, {
                    ...
                    try {
                        ...
                        // Store the message data in chrome.storage
                        const messageData = {
                            message: data,
                            recipientName: experienceDetails[0]?.name || 'Unknown',
                            recipientTitle: experienceDetails[0]?.title || 'Unknown',
                        ...
                        chrome.storage.sync.get(['savedMessages'], function(result) {
                            ...
                            chrome.storage.sync.set({ savedMessages: savedMessages });
                        });
